...
LABEL org.opencontainers.image.source="https://github.com/hecate-services/hecate-mods"
...
WORKDIR /app
COPY --from=builder /build/_build/prod/rel/hecate_mods ./

ENV HOME=/app
ENV RELX_REPLACE_OS_VARS=true

ENV HECATE_NODE_NAME=hecate_mods
ENV HECATE_NODE_HOST=127.0.0.1
ENV HECATE_COOKIE=hecate_mods
ENV HECATE_HEALTH_PORT=8462
...
CMD ["/app/bin/hecate_mods", "foreground"]
